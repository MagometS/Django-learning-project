...
from api.v1.views.course_view import CourseViewSet, GroupViewSet, LessonViewSet, AvailableCourseView
...
urlpatterns = [
    ...
    path("courses/available/", AvailableCourseView.as_view(), name="available-courses"),
